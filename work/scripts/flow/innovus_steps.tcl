...
if {[get_feature clock_flexible_htree]} {
  ...
  ############################################################################
  # STEP add_clock_htree
  ############################################################################
  create_flow_step -name add_clock_htree -owner cadence {
    #- implement flexible H-tree for specified nets
...
create_flow_step -name run_route -owner cadence {
  ...
  if {[get_feature route_track_opt]} {
