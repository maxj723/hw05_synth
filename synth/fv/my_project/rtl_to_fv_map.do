...
# Generated on: Fri May 09 16:10:44 EDT 2025 (Fri May 09 20:10:44 UTC 2025)
...
set logfile fv/my_project/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/my_project -revised fv_map
...
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -sv09 ../src/my_project.sv
elaborate_design -golden -root {my_project} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/my_project/fv_map.v.gz
elaborate_design -revised -root {my_project}
...
#add_name_alias fv/my_project/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.my_project.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.my_project.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.my_project.rtl.fv_map.rpt
