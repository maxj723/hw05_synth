...
# Generated on: Sat May 03 16:14:29 EDT 2025 (Sat May 03 20:14:29 UTC 2025)
...
set logfile fv/riscv_stub/rtl_to_fv_map.log ;# user can modify this name for succeeding runs
...
read_implementation_information fv/riscv_stub -revised fv_map
...
set env(CDN_SYNTH_ROOT) "/escnfs/home/csesoft/cadence/installs/GENUS211/tools.lnx86"
set CDN_SYNTH_ROOT      "/escnfs/home/csesoft/cadence/installs/GENUS211/tools.lnx86"
set env(CW_DIR) "/escnfs/home/csesoft/cadence/installs/GENUS211/tools.lnx86/lib/chipware"
set CW_DIR      "/escnfs/home/csesoft/cadence/installs/GENUS211/tools.lnx86/lib/chipware"
set lec_version_required "21.20249"
if { ($lec_version < $lec_version_required) &&
    [file exists /escnfs/home/csesoft/cadence/installs/GENUS211/tools.lnx86/lib/chipware/old_encrypt_sim]} {
    set env(CW_DIR_SIM) "/escnfs/home/csesoft/cadence/installs/GENUS211/tools.lnx86/lib/chipware/old_encrypt_sim"
    set CW_DIR_SIM      "/escnfs/home/csesoft/cadence/installs/GENUS211/tools.lnx86/lib/chipware/old_encrypt_sim"
} else {
    set env(CW_DIR_SIM) "/escnfs/home/csesoft/cadence/installs/GENUS211/tools.lnx86/lib/chipware/sim"
    set CW_DIR_SIM      "/escnfs/home/csesoft/cadence/installs/GENUS211/tools.lnx86/lib/chipware/sim"
}
...
read_design -enumconstraint -define SYNTHESIS  -merge bbox -golden -lastmod -noelab  -sv09 ../src/riscv_stub.sv
elaborate_design -golden -root {riscv_stub} -rootonly -rootonly  

read_design -verilog95   -revised -lastmod -noelab fv/riscv_stub/fv_map.v.gz
elaborate_design -revised -root {riscv_stub}
...
#add_name_alias fv/riscv_stub/fv_map.singlebit.original_name.alias.json.gz -revised
...
set_system_mode lec
write_compared_points noneq.compared_points.riscv_stub.rtl.fv_map.tcl -class noneq -tclmode -replace
set lec_version_required "21.10100"
if {$lec_version >= $lec_version_required} {
    analyze_nonequivalent -source_diagnosis
    report_nonequivalent_analysis > noneq.source_diag.riscv_stub.rtl.fv_map.rpt
}
report_test_vector -noneq > noneq.test_vector.riscv_stub.rtl.fv_map.rpt
